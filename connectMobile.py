...
# # Địa chỉ IP của điện thoại (cập nhật địa chỉ IP và cổng theo ứng dụng IP Webcam)
...
# while True:
#     # Đọc từng khung hình từ stream
#     ret, frame = cap.read()
    
#     if not ret:
#         print("Không thể nhận dữ liệu từ video stream")
#         break
...
# Function to capture 10 images from the IP Webcam
def capture_images(name, ip_webcam_url, save_dir='dataset_split'):
...
def main():
    ...
    # Capture images
    capture_images(name, ip_webcam_url)
